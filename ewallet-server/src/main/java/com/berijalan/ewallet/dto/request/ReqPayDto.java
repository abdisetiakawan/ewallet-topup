...
@Schema(description = "Payload pembayaran merchant.")
public record ReqPayDto(
        ...
        @Schema(description = "Deskripsi transaksi yang disimpan pada riwayat pembayaran.", example = "Top-up Gopay", maxLength = 255)
